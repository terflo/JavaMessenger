...
public class Constants {
    ...
    public final static String reg = "RegisterRequest";
    public final static String log = "LoginRequest";
    public final static String msg = "MessageRequest";
    public final static String key = "KeyRequest";
